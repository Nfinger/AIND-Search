# AIND-Search
NOTE: The comments of search.py and searchAgents.py were edited on 9/13/10 to resolve some inconsistencies between this page and the code, and to fix some textbook page numbers. YOU NEED NOT download everything again, unless some bugs in the comments bother you.
